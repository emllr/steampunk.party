  ...
  return (
    <section className="relative">
      ...
      <div className="mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-2xl border border-bronze-700/40 bg-gradient-to-br from-amber-50/70 via-amber-100/40 to-amber-200/30 p-8 sm:p-12 shadow-[inset_0_0_18px_rgba(0,0,0,0.12),0_24px_48px_-24px_rgba(0,0,0,0.45)]">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl tracking-tight text-bronze-900 drop-shadow-[0_1px_0_rgba(255,255,255,0.25)]">
            Welcome to the Workshop
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-bronze-800/90">
